...
@click.option("--store_id", prompt="id Store", help="Id of the store default=1",default='1')
@click.option("--upperprice", prompt="Upper Price", help="Max Price to lookup default=5")
@click.option("--lowerprice", prompt="Lower Price", help="Lower Price to lookup defaul=0",default='0')
@click.option("--pagenumber", prompt="Page Number", help="Number of the page of deals default=1",default='1')
def main(url, output_file,store_id,upperprice,lowerprice,pagenumber):
    downloader = DealListDownloader(url, output_file,store_id,upperprice,lowerprice,pagenumber)
